...
public class MicroClusterC extends ClustreamKernelMOAModified {
    ...
    public MicroClusterC(ClustreamKernelMOAModified element, String labelClasse, String category, int time) {
        super(element);
