...
public class MicroClusterMOA extends CFCluster {
    ...
    public MicroClusterMOA(double[] center, int dimensions, long creationTimestamp, double lambda, Timestamp currentTimestamp) {
    ...
    public MicroClusterMOA(Instance instance, int dimensions, long timestamp, double lambda, Timestamp currentTimestamp) {
        this(instance.toDoubleArray(), dimensions, timestamp, lambda, currentTimestamp);
    }

    //CONSTRUTOR PARA MINAS
    public MicroClusterMOA(MicroClusterMOA element) {
        
        super(element);
        this.creationTimestamp = element.creationTimestamp;
        this.lastEditT = element.creationTimestamp;
        this.lambda = element.lambda;
        this.currentTimestamp = element.currentTimestamp;
    }
    ...
    public double getRadius() {
        return getRadius(currentTimestamp.getTimestamp()) * radiusFactor * 6 ;
    }
...
//        }
//
//        return getDeviationElaine() * 2.0/10000;
...
//    }
    ...
    @Override
    public MicroClusterMOA copy() {
        MicroClusterMOA copy = new MicroClusterMOA(this.LS.clone(), this.LS.length, this.getCreationTime(), this.lambda, this.currentTimestamp);
